// src/Views/Credits/Credits.js
import React from "react";
import "./Credits.css";

export default function Credits({ progress }) {
  return (
    <div
      ...
      <div className="credits-content">
        ...
        <div className="credits-section">
          ...
          <p className="publication-authors">
            Mazzarello M., Klimenka M., Sanatani R., Eshtiyagh J., Yao Y., Santi
            P., Duarte F., Florida R., Ratti C. (2025)
          </p>
          <a
